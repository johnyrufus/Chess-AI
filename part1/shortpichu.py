...
'''
    Extra Credit: 
    This is the entire Pichu program, with a reasonable heuristic of counting the number of pieces and the value of the pieces and using mini max 
    Right now, this counts to 13 lines starting at 21 to 36 and excluding blank lines and the main input method 
    as mentioned in the assignment.
    
    Liberties taken in counting lines:
    Lines 21, 31 35 are around 300 characters long
